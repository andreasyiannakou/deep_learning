...
loss_acc_graphs_combined(0, 20, 'Simple RNN')
loss_acc_graphs_combined(1, 20, 'LSTM')
loss_acc_graphs_combined(9, 20, 'LSTM with RD')
loss_acc_graphs_combined(10, 20, 'GRU')
loss_acc_graphs_combined(4, 20, 'GRU with RD')
loss_acc_graphs_combined(12, 20, 'Bidirectional')
loss_acc_graphs_combined(6, 20, 'Bidirectional with RD')
